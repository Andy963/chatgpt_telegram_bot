...
class User(Base):
    ...
    api_count = Column(
        Integer, nullable=False, default=10, comment="Normal user can use 10 times"
    )
    total_api_count = Column(
        Integer, nullable=False, default=0, comment="Total used api count"
    )
